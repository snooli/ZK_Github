...
public class dotsClient {
	...
	// <session ID, client>
	private static Map<String, dotsClientImpl> clients = new HashMap<String, dotsClientImpl>();

	public static dotsClientImpl get() {

		String sessionId = Sessions.getCurrent().toString();

		// create a new client
		if (!clients.containsKey(sessionId)) {
			clients.put(sessionId, new dotsClientImpl());
		}
	...
	public static class dotsClientImpl {

		private InitialContext ctx = null;

		public dotsClientImpl() {
