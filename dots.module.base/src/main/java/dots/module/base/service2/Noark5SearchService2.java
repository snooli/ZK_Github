...
@WebContext(contextRoot = "/n5", urlPattern = "/Noark5SearchService2")
@Stateless(mappedName = "Noark5SearchService2")
public class Noark5SearchService2 implements INoark5SearchService2 {
