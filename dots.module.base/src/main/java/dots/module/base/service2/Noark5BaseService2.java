...
@WebContext(contextRoot = "/n5", urlPattern = "/Noark5BaseService2")
@Stateless(mappedName = "Noark5BaseService2")
public class Noark5BaseService2 implements INoark5BaseService2 {
	...
	public Result classCreate(
			@WebParam(name = "csSystemId") String csSystemId, 
			@WebParam(name = "parentClassSystemId") String parentClassSystemId,
			@WebParam(name = "title") String title,
			@WebParam(name = "description") String description, 
			@WebParam(name = "createdBy") String createdBy) {
		// TODO Auto-generated method stub
	...
	public ClassBean caseFileGetClass(@WebParam(name = "systemId") String systemId) {
		// TODO Auto-generated method stub
		return null;
	}
