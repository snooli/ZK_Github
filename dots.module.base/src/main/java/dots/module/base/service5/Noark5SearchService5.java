...
@WebContext(contextRoot = "/n5", urlPattern = "/Noark5SearchService5")
@Stateless(mappedName = "Noark5SearchService5")
public class Noark5SearchService5 implements INoark5SearchService5 {
